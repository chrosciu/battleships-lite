...
class ShooterTest {
    private static final Point VERTICAL_TWO_FIELDS_SHIP_FIRST_FIELD = of(3, 4);
    private static final Point VERTICAL_TWO_FIELDS_SHIP_SECOND_FIELD = of(3, 5);

    private static final Point ONE_FIELD_SHIP_FIELD = of(7, 2);

    private static final Point ANOTHER_ONE_FIELD_SHIP_FIELD = of(6, 5);

    private static final Point HORIZONTAL_TWO_FIELDS_SHIP_FIRST_FIELD = of(1, 1);
    private static final Point HORIZONTAL_TWO_FIELDS_SHIP_SECOND_FIELD = of(2, 1);

    private static final Point FIELD_WITHOUT_SHIP = of(1, 2);
    private static final Point ANOTHER_FIELD_WITHOUT_SHIP = of(4, 4);
