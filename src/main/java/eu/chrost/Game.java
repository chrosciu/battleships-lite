...
public class Game {
    public static void main(String[] args) {
        ...
        List<Shooter.ShipDefinition> rv = new ArrayList<>();
        //... and fill it with ships placed on board
        rv.add(Shooter.ShipDefinition.of(Field.of(1, 1), 4, VERTICAL));
        rv.add(Shooter.ShipDefinition.of(Field.of(6, 7), 2, HORIZONTAL));
